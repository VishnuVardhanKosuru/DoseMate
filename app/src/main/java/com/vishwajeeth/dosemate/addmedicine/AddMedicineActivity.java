...
//        // Create the presenter
        mAddMedicinePresenter = new AddMedicinePresenter(
                medId,
                (MedicineDataSource) Injection.provideMedicineRepository(getApplicationContext()),
                (AddMedicineContract.View) addMedicineFragment,
